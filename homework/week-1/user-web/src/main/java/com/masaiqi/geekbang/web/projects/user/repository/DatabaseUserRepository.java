...
import com.masaiqi.geekbang.web.projects.user.function.ThrowableFunction;
...
import static com.masaiqi.geekbang.web.config.DatabaseConnectionManager.getConnection;
import static com.masaiqi.geekbang.web.config.DatabaseConnectionManager.releaseConnection;
import static org.apache.commons.lang.ClassUtils.wrapperToPrimitive;

/**
 * @author masaiqi
 * @date 2021/3/1 11:08 PM
 */
public class DatabaseUserRepository implements UserRepository {
    ...
    public boolean save(User user) {
        return update("INSERT INTO users(name,password,email,phoneNumber) VALUES" +
                "(?,?,?,?)", t -> t > 1, e -> {
    ...
    protected <T> T update(String sql, ThrowableFunction<Integer, T> function,
                           Consumer<Throwable> exceptionHandler, Object... args) {
        Connection connection = null;
        try {
            connection = getConnection();
