...
import com.masaiqi.geekbang.web.projects.user.sql.LocalTransactional;
import com.masaiqi.geekbang.web.projects.user.validator.bean.validation.UserValid;
...
//        transaction.begin();
        ...
        validate.forEach(e -> System.err.println(e.getMessage().toString()));
